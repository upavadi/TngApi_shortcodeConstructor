<?php
class TngWp_Shortcode_RandomPhotoShortcode extends TngWp_Shortcode_AbstractShortcode
{
    const SHORTCODE = 'TngWp_RandomPhoto';
    ...
    public function show()
    {
      $this->content->init();
       ...
       //This html file to show your pagerandomPhotoShortcode.html', $context);
        ...
        return $this->templates->render('random-photo-shortcode.html', $context);
