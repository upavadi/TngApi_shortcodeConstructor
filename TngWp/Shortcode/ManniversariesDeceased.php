...
*
***/
class TngWp_Shortcode_ManniversariesDeceased extends TngWp_Shortcode_AbstractShortcode
{
    const SHORTCODE = 'TngWp_manniversariesDeceased';
    ...
    public function show()
    {
        ...
        return $this->templates->render('manniversaries-deceased.html', $context);
        }
    }
}