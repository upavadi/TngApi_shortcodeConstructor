...
/***********
 * In SQL below use
 * mediatypeID = '$headstonepath' for headstones
 * mediatypeID = '$documentpath' for Documents
 * mediatypeID = '$photopath' for photos
 */
...
where (m.defphoto = 1 AND m2.living = 0) OR (alwayson = 1) OR mediatypeID = '$headstonepath' ORDER BY RAND()";

$result2 = $db->query($sql3);
$imgrow = $result2->fetch_assoc();

$showmedia_url = 'showmedia.php?'; //add this
